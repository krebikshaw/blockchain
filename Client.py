'''
操作方式：
啟動 client 程式: python3 Client.py 8888
建立公私鑰: 1 Enter
查詢餘額：2 Enter 複製自己的地址 Enter
透過礦工地址會一筆錢給自己：3 Enter 複製礦工地址 複製礦工私鑰 複製客戶地址 輸入金額 輸入小費 輸入訊息
'''
...
def generate_address():
  ...
  return get_address_from_public(public_key), \
    extract_from_private(private_key)
